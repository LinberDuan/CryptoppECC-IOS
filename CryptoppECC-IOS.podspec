#
#  Be sure to run `pod spec lint CryptoppECC-IOS.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source_files  = "CryptoppECC-IOS/CryptoppLibrary/*.h", "CryptoppECC-IOS/CryptoppWrapper/*.{h,m}"
